...
export function UseCaseMarquee() {
  ...
  return (
    <section id="usecases" className="py-12 overflow-hidden border-y-2 border-border">
      <div className="flex" style={{ animation: 'marquee 30s linear infinite' }}>
        {doubled.map((uc, i) => (
          <div key={i} className="flex-shrink-0 flex items-center gap-6 mx-6">
            <span className="text-2xl md:text-4xl font-bold text-foreground/10 whitespace-nowrap uppercase tracking-wider">
              {uc}
            </span>
